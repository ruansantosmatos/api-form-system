...
import type {
  ...
  FormServiceGetFieldOptions,
  FormServiceCreateFieldOption,
  FormServiceUpdateFieldOption,
  FormServiceDeleteFieldOption,
...
export class FormService {
  ...
  async getFieldOptions({ form_id, field_id }: FormServiceGetFieldOptions) {
    await this.findFieldInForm(field_id, form_id)
    return this.prisma.formFieldOption.findMany({ where: { field_id }, orderBy: { id: 'asc' } })
  }

  async createFieldOption({ form_id, field_id, data }: FormServiceCreateFieldOption) {
    await this.findFieldInForm(field_id, form_id)
    return this.prisma.formFieldOption.create({ data: { ...data, field_id } })
  }

  async updateFieldOption({ form_id, field_id, option_id, data }: FormServiceUpdateFieldOption) {
    await this.findFieldInForm(field_id, form_id)
  ...
  async deleteFieldOption({ form_id, field_id, option_id }: FormServiceDeleteFieldOption) {
    await this.findFieldInForm(field_id, form_id)
